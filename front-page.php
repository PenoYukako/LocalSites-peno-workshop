            ...
            <div class="inner">
              <ul>
                ...
                <li>
                  ...
                  <a href="#"><i class="fab fa-instagram faStyle sns"></i></a>
                </li>
                <li>イラストを描くことが得意なフリーランスのデザイナーです。<br>WEB、DTP、コーディングなど、幅広く制作業務に携わっています。　趣味は漫画を描くこと。</li>
              </ul>
              <div class="designWorks">
                <a href="<?php echo home_url('/private-works/'); ?>" class="btn btn__Bk"><span>デザイン実績はこちら<sup>※</sup><i class="fa-solid fa-caret-right position-fa-left sns"></i></span></a>
              </div>
            </div>
          </div>
